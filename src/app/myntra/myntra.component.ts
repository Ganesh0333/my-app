...
public categoryList:any=[
    ...
    public allProducts=this.products
    ...
    changeCategory() {
        ...
        for(let category of this.categoryList){
            ...
            if(category.checked==true){
                selectedCategory.push(category.category)
            }

        }
        this.products=this.allProducts.filter((product:any)=>selectedCategory.includes(product.category))
    }
        upto50(){
            this.products=this.products.filter((product:any)=>product.price>0 && product.price<=50)
        }
        upto300(){
        ...
        upto1000(){
            this.products=this.products.filter((product:any)=>product.price>600)
        }
